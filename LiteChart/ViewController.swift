...
//        var configure = LiteChartViewParameters(inputDatas: .bar(inputDatas: [(.init(lightUIColor: .green), [20, 30, 40, 50]), (.init(lightUIColor: .red), [20, 30, 40, 20]), (.init(lightUIColor: .yellow), [20, 30, 100, 20]), (.init(lightUIColor: .blue), [20, 30, 100, 120])], coupleTitle: ["Water", "Electoric", "Gas", "Apple"]))
...
//        var configure = LiteChartViewParameters(inputDatas: .bubble(inputDatas: datas))
        var configure = LiteChartViewParameters(inputDatas: .radar(inputDatas: [(LiteChartDarkLightColor.init(lightUIColor: .green), [0.20, 0.30, 0.40 ,0.50]), (LiteChartDarkLightColor.init(lightUIColor: .red), [0.30, 0.30, 0.50 ,0.9])]))
//        var configure = LiteChartViewParameters(inputDatas: .funal(inputDatas: [(100, .init(lightUIColor: .red)), (50, .init(lightUIColor: .purple))]))
        ...
        configure.barDirection = .leftToRight
        configure.displayDataMode = .original
